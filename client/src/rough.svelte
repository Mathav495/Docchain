      ...
      <div
        ...
        <div class="mt-5 h-0 flex-1 overflow-y-auto">
          <nav class="space-y-1 px-2">
            ...
            <a
              href="#"
              class="group flex items-center rounded-md px-2 py-2 text-base font-medium text-indigo-100 hover:bg-indigo-600">
    ...
    <div class="flex flex-grow flex-col overflow-y-auto bg-indigo-700 pt-5">
      ...
      <div class="mt-5 flex flex-1 flex-col">
        <nav class="flex-1 space-y-1 px-2 pb-4">
          ...
          <a
            href="#"
            class="group flex items-center rounded-md bg-indigo-800 px-2 py-2 text-sm font-medium text-white">
            <!-- Heroicon name: outline/home -->
            <svg
